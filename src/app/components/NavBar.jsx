    ...
    return(
        <header className='flex bg-black h-12 w-full overflow-y-hidden sticky'>
            ...
            <div className='font-bold text-[#ADB7BE] mt-3'>
                <Link href='/' className='mt-8 sm:ml-3 sm:mr-3 xs:ml-3 xs:mr-3 lg:mt-16 lg:mb-16 lg:ml-14 lg:mr-14 lg:text-lg sm:text-xs xs:text-xs'>Home</Link>
                <Link href='/About' className='mt-8 sm:ml-3 sm:mr-3 xs:ml-3 xs:mr-3 lg:mt-16 lg:mb-16 lg:ml-14 lg:mr-14 lg:text-lg sm:text-xs xs:text-xs'>About</Link>
                ...
                <Link href='/Terminal' className='mt-8 sm:ml-3 sm:mr-3 xs:ml-3 xs:mr-3 lg:mt-16 lg:mb-16 lg:ml-14 lg:mr-14 lg:text-lg sm:text-xs xs:text-xs'>Terminal</Link>
            </div>
